...
namespace ServeIt.Data.Migrations
{
    ...
    [Migration("20210720074630_UpdateMenuTable2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServeIt.Data.Models.MenuDish", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ServeIt.Data.Models.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ServeIt.Data.Models.RatingUser", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ServeIt.Data.Models.RestaurantMenu", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ServeIt.Data.Models.RatingUser", b =>
                {
                    b.HasOne("ServeIt.Data.Models.Rating", "Rating")
            ...
            modelBuilder.Entity("ServeIt.Data.Models.RestaurantMenu", b =>
                {
                    b.HasOne("ServeIt.Data.Models.Menu", "Menu")
                        .WithOne("RestaurantMenu")
                        .HasForeignKey("ServeIt.Data.Models.RestaurantMenu", "MenuId");

                    b.HasOne("ServeIt.Data.Models.Restaurant", "Restaurant")
                        .WithOne("restaurantMenu")
                        .HasForeignKey("ServeIt.Data.Models.RestaurantMenu", "RestaurantId");
